...
def _print_startup_banner():
    ...
    print(f"  EMAIL_ADDRESS: {'[OK] ' + SMTP_USERNAME if SMTP_USERNAME else '[FAIL]  NOT SET'}")
    print(f"  EMAIL_APP_PASSWORD: {'[OK]  configured (hidden)' if SMTP_PASSWORD else '[FAIL]  NOT SET'}")
    print(f"  EMAIL FROM   : {'[OK] ' + EMAIL_FROM if EMAIL_FROM else '[FAIL]  NOT SET'}")
    print(f"  MODE         : {'[OK]  LIVE — SMTP email reminders enabled' if ok else '[FAIL]  INCOMPLETE'}")
    print(sep)
